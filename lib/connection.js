...
Connection.prototype.publish = function (routingKey, body, options, callback) {
  var self = this;
  var confirm = !!(callback !== undefined && callback !== null);
  if (!this._defaultExchange) this._defaultExchange = this.exchange();
  this._defaultExchange.options.confirm = confirm;
  this._defaultExchange.once('open', function() {
    self._defaultExchange.publish(routingKey, body, options, callback);
  });
};
